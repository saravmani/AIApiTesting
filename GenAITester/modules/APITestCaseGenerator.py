...
class APITestCaseGenerator:
    def __init__(self,baseApiUrl):
        self.assistant = AssistantAgent(
            ...
            Once test cases are generated call the funciton file_Writer with parameters - api url (api_url), and test cases as content  
        ...
        self.assistant.register_for_llm(name="file_Writer", description="Write the generated PyTest test cases into a file")(file_Writer)       
